...
function SocialIcon({ name }) {
  return (
    ...
    >
      {name === "linkedin" ? (
        <>
          <path d="M4 8h4v13H4zM10 8h4v2c1-3 7-3 7 3v8h-4v-7c0-3-3-3-3 0v7h-4z" />
        ...
        <path d="M14 2h4c0 3 2 5 5 5v4c-2 0-4-1-5-2v8a6 6 0 1 1-6-6v4a2 2 0 1 0 2 2Z" />
      ) : (
        <path d="M3 3h5l5 7 6-7h2l-7 9 8 9h-5l-5-7-6 7H3l8-9Zm3 2 12 14h1L7 5Z" />
      )}
    </svg>
  );
}
