...
export default function GrowthSignup({ newsletter = false }) {
 ...
 const whiteNewsletter = newsletter && (pathname === "/about" || pathname === "/services" || pathname.startsWith("/services/"));
